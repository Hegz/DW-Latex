...
\index{Moves!fictional triggers of}
...
\index{Monsters!multiple attacking}
\index{Multiple Attackers}
...
\subsection{Healing}
\index{Healing|seealso{Recovery (move)}}
\index{Healing}
...
\subsection{Death}
\index{Death|seealso{Last Breath (move)}}
\index{Death}
...
\index{XP}
\index{Leveling Up|seealso{Level Up (move)}}
\index{Leveling Up}
...
\index{Moves!multiclass moves}
\subsubsection{Requires and Replaces}
\index{Moves!class move requirements}
...
\index{Hirelings!skills!Burglar}
...
\index{Hirelings!skills!Minstrel}
...
\index{Hirelings!skills!Protector}
...
\index{Hirelings!skills!Tracker}
...
\index{Hirelings!skills!Warrior}
