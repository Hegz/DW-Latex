...
\index{Adventure vs Campaign}
\index{Campaign vs Adventure}
\index{Fronts!campaign and adventure}
...
\index{Grim Portents (danger component)}
...
\index{Impending Doom (danger component)}
...
\index{Fronts!resolving}
\index{Resolving a Front}
...
\index{Fronts!adventure, multiple}
