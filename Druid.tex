...
\begin{itemize}
\item Wise Eyes, Wild Eyes, or Haunting Eyes

\item Furry Hood, Messy Hair, or Braided Hair

\item Ceremonial Garb, Practical Leathers, or Weathered Hides
\end{itemize}
\section*{Stats}
...
\subsection{Studied Essence}

When you \textbf{spend time in contemplation of an animal spirit}
, you may add its species to those you can assume using shapeshifting.
\index{Druid (class)!moves|)}
\section*{Alignment}
...
\begin{itemize}
\item Hide armor (1 armor, 1 weight)
\item Wooden shield (+1 armor, 1 weight)

\end{itemize}
Choose your armament: \begin{itemize}
\item Shillelagh (close, 2 weight)
\item Staff (close, two-handed, 1 weight)
\item Spear (close, thrown, near, 1 weight)

\end{itemize}
Choose one: \begin{itemize}
\item Adventuring gear (1 weight)
\item Poultices and herbs (2 uses, 1 weight)
\item Halfling pipeleaf (0 weight)
\item 3 antitoxin (0 weight)
...
\subsection{Hunter's Brother}

Choose one move from the ranger class list.
\subsection{Red of Tooth and Claw}

When you \textbf{are in an appropriate animal form}
(something dangerous) increase your damage to d8.
\subsection{Communion of Whispers}

When \textbf{you spend time in a place, making note of its resident spirits and calling on the spirits of the land}
...
When you \textbf{take damage while shapeshifted}
you may choose to revert to your natural form to negate the damage.
\subsection{Thing-Talker}
...
\subsection{Elemental Mastery}

When you \textbf{call on the primal spirits of fire, water, earth or air to perform a task for you}
roll+Wis. *On a 10+ choose two. *On a 7--9 choose one. *On a miss, some catastrophe occurs as a result of your calling.
\begin{itemize}
...
When you \textbf{deal damage}
, take 1 balance. When you touch someone and channel the spirits of life you may spend balance. For each balance spent, heal 1d4 HP.

\vspace{\baselineskip}
{\bfseries When you gain a level from 6--10, choose from these moves or the level 2--5 moves.}
\subsection{Embracing No Form}

When you shapeshift, roll 1d4 and add that total to your hold.
\subsection{Doppelg\~A¤nger's Dance}
...
\subsection{Blood and Thunder}

Replaces: Red of Tooth and Claw

When you \textbf{are in an appropriate animal form}
(something dangerous) increase your damage to d10.
\subsection{The Druid Sleep}
...
\subsection{Stalker's Sister}

Choose one move from the ranger class list.
\subsection{Formshaper}
